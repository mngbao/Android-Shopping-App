package com.example.shopi.adapter;
...
import com.example.shopi.databinding.CartRowBinding;
import com.example.shopi.models.CartItems;

public class CartListAdapter extends ListAdapter<CartItems, CartListAdapter.CartVH> {

    private CartInterface cartInterface;
    public CartListAdapter(CartInterface cartInterface) {
        super(CartItems.itemCallback);
    ...
    public interface CartInterface {
        ...
        void changeQuantity(CartItems cartItem, int quantity);
    }
}
